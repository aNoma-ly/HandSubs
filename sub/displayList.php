<?php 
	...
	$sql = "SELECT id,Subscription_name,Status,Billing_cycle,Start_date,Price FROM subscriptions";
            ...
            ?>
              <tr> 
                ...
                <td> <a href="updatePage.php?edit=<?php echo $rows['id']; ?>" class="btn btn-primary">Edit</a>
                    <a href="delete.php?delete=<?php echo $rows['id']; ?>" class="btn btn-success">Delete</a>
              </td> 
              </tr> 
            <?php } ?> 
          </tbody>
